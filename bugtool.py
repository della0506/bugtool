...
def bugtool():
    ...
    variables = {"first": 50, "last": 50, "jql": "project = 'DX' AND type = Bug AND 'Epic Link' = DX-227 ORDER BY created DESC", "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
