...
def bugtool():
    ...
    cookie = {"ajs_anonymous_id":"%22772a5426-d38d-40f4-91c7-ceedc0d30a3f%22","atlassian.xsrf.token":"725e5e66-f148-4f2e-a701-9a168378c0b7_cd0ba33e1b1cd5cb67bfc5665465f254f4037271_lin","jira.navigation.expandableMenuStates.classic-issues-setttings":"{%22submenuActive%22:false%2C%22expanded%22:true}","jira.navigation.expandableMenuStates.classic-apps-setttings":"{%22submenuActive%22:false%2C%22expanded%22:true}","JSESSIONID":"949AC3427B8A0790B91607BCB2E27F14","cloud.session.token":"eyJraWQiOiJzZXNzaW9uLXNlcnZpY2VcL3Byb2QtMTU5Mjg1ODM5NCIsImFsZyI6IlJTMjU2In0..yCh-Ul_Hj5yodeilllFpQ_979KHZVFLbbu62bN8FkOXEgygSx1CQPWZRXivzvXbC_RcXq9H6Cy6uRZ6-vPYLT_Ghegn7Zg3FXeYvxb4OxI1SVrYievekNkTGGVxNaDBhx4VG8-_BbbZYXjI6uXPiY5FFamWZd0x7a_-jcqjqnwmfRmLHIdp_hVfMvQniProGVQj6FJp4OfFt-LZT9jJHGoLpc4QKjOQ5zN_x8jWdVvGEbC006HUdAI5qy7PrsWkVDou7WGDpZtQ89gZnHzDkX8Ot0axyZImfhxnQVYztVTpXf7mfzIsqpoopULxbH4B2CpOn1X-tLMviJSB6hvOAcw"}
    ...
    variables = {"first": 50, "last": 50, "jql": "project = 'DX' AND type = Bug AND 'Epic Link' = DX-189 ORDER BY created DESC", "amountOfIds": 1000, "isMaxResultsLimitEnabled": True}
    ...
    send = requests.post('https://open.feishu.cn/open-apis/bot/v2/hook/0b2f31de-26c9-454d-8107-8f2040f2e25d',json.dumps(p))
